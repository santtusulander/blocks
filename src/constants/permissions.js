...
export const VIEW_BRAND_DASHBOARD_SECTION = 'VIEW_BRAND_DASHBOARD_SECTION'
...
export const CONFIGURE_DNS = 'CONFIGURE_DNS'
...
export const SHOW_STORAGE_CONTEXT_MENU = 'SHOW_STORAGE_CONTEXT_MENU'
