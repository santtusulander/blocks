...
import {
  ...
  API_DOCUMENTATION_PATH_SP_ACCOUNT,
  API_DOCUMENTATION_PATH_OTHER_ACCOUNT
...
class SupportTabDocumentation extends React.Component {
  render() {
    ...
    let documentPath = ""
    let apiPath = API_DOCUMENTATION_PATH_OTHER_ACCOUNT
    ...
    switch (accountType) {
      ...
      case ACCOUNT_TYPE_SERVICE_PROVIDER:
        ...
        apiPath = API_DOCUMENTATION_PATH_SP_ACCOUNT
        break
