 ...
 */
export function getCitiesWithinBounds({ params, filters, location, coordinates, activeHostConfiguredName, actions, aggregate } = {}) {
  ...
  actions.fetchByCity({...byCityOpts, aggregate_granularity: aggregate }).then(
