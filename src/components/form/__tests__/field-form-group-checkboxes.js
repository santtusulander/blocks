...
jest.unmock('../field-form-group-checkboxes')
import FieldFormGroupCheckboxes from '../field-form-group-checkboxes'

describe('FieldFormGroupCheckboxes', () => {
  ...
  beforeEach(() => {
    subject = (error,
      ...
      return shallow(
        <FieldFormGroupCheckboxes {...props}/>
      )
    }
  })
