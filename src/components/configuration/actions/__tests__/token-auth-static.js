...
jest.unmock('../token-auth-static.jsx')

const TokenAuthStatic = require('../token-auth-static.jsx').TokenAuthStatic

describe('TokenAuthStatic', () => {
  ...
  beforeEach(() => {
    ...
    component = shallow(<TokenAuthStatic {...props} />)
