...
jest.unmock('../defaults-cache-key-query-string.jsx')
import DefaultsCacheKeyQueryString from '../defaults-cache-key-query-string.jsx'
...
describe('DefaultsCacheKeyQueryString', () => {
  ...
  beforeEach(() => {
    ...
    subject = (field_name) => {
      ...
      return shallow(<DefaultsCacheKeyQueryString {...props}/>)
    }
  })
