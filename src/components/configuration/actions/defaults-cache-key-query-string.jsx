...
class DefaultsCacheKeyQueryStringForm extends React.Component {
  constructor(props) {
    super(props);
...
DefaultsCacheKeyQueryStringForm.displayName = 'DefaultsCacheKeyQueryStringForm'
DefaultsCacheKeyQueryStringForm.propTypes = {
...
export default injectIntl(DefaultsCacheKeyQueryStringForm)
