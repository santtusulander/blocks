...
export const USER_FINISH_FETCH = 'USER_FINISH_FETCH'
export const USER_TOKEN_CHECKED = 'USER_TOKEN_CHECKED'
export const USER_FETCHED = 'USER_FETCHED'
export const USER_FETCHED_ALL = 'USER_FETCHED_ALL'
...
export const USER_PASSWORD_RESET_TOKEN_INFO = 'USER_PASSWORD_RESET_TOKEN_INFO'
...
export const USER_ACCESS_KEY_RECEIVED = 'USER_ACCESS_KEY_RECEIVED'
