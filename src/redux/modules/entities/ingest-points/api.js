...
const ingestPointSchema = new schema.Entity('ingestPoint', {},{
 ...
 * @param  {String} group
 * @param  {String} id
 * @return {Object} normalized ingestPoint
 */
export const fetch = ({id, ...params}) => {
  ...
  .then( ({data}) => {
    return normalize({ id: params.group, networks: [ data ] }, ingestPointSchema)
  })
}
